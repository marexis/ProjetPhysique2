...
while True:
    ...
    dessiner_arduino(sortie_memorisee(), sortie_CD4511, sortie_CD4028(sortie_memorisee()) , sortie_bouton)
    dessiner_afficheur(sortie_CD4511, sortie_CD4028(sortie_memorisee()))
    #print("###########################\n",latence_mat)
    pygame.display.flip()
